      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            ...
            <p className="text-xs text-gray-500 italic">Recommendation: Upload high-resolution square images (min 800x800px).</p>
          </div>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="inline-flex items-center px-10 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? 'Processing...' : (
                <><Save className="mr-2" size={20} /> Save Product</>
              )}
            </button>
          </div>
        </form>
